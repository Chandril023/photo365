...
<div className="container">
  <aside className="carousel ">
    <div className="carousel__wrapper ">
      <div className="item" id="slide-0"><img src="https://assets.codepen.io/108082/jake-and-fin-1.jpg" alt="" width="418" height="418"/></div>
      <div className="item" id="slide-1"><img src="https://assets.codepen.io/108082/jake-and-fin-2.jpg" alt="" width="418" height="418"/></div>
      <div className="item" id="slide-2"><img src="https://assets.codepen.io/108082/jake-and-fin-3.jpg" alt="" width="418" height="418"/></div>
      <div className="item" id="slide-3"><img src="https://assets.codepen.io/108082/jake-and-fin-4.jpg" alt="" width="418" height="418"/></div>
      <div className="item" id="slide-4"><img src="https://assets.codepen.io/108082/jake-and-fin-5.jpg" alt="" width="418" height="418"/></div>
      <div className="item" id="slide-5"><img src="https://assets.codepen.io/108082/jake-and-fin-6.jpg" alt="" width="418" height="418"/></div>
      <div className="item" id="slide-6"><img src="https://assets.codepen.io/108082/jake-and-fin-7.jpg" alt="" width="418" height="418"/></div>
    </div>
  </aside>
...
Kolkata, India
    ...
    <footer className="instagram__buttons">
      <div className="left">
        <svg className="instagram__icon instagram__icon--heart" fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
